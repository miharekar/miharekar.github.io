...
comments: true
header:
  image: /images/features/miha-marathon-alpner.jpg
  caption: "Photo: [Marko Alpner](https://alpner.si/)"
---
...
_Technically_ I wrote a technical blog post last year, but it's [a guest post on my friend's blog](https://radanskoric.com/guest-articles/pagy-out-turbo-in) and it was only published this year. If you're interested in the [Turbo and/or Hotwire stack](https://hotwired.dev/), you should definitely check it.
